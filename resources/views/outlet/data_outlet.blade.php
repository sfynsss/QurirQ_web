                    ...
                    <div class="modal-body">
                        <div class="card-inner">
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label" for="full-name-1">Latitude</label>
                                        <div class="form-control-wrap">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-label" for="full-name-1">Longitude</label>
                                        <div class="form-control-wrap">
        ...
        <table class="table table-orders">
            ...
            <tbody class="tb-odr-body">
                ...
                <tr class="tb-odr-item">
                    ...
                    <td>
                        <button type="submit" class="btn btn-warning" data-toggle="modal" data-target=".modal_input" onclick="ubahOutlet('{{$data->id}}', '{{$data->nama_outlet}}', '{{$data->keterangan}}', '{{$data->status}}', '{{$data->alamat}}', '{{$data->lat}}', '{{$data->long}}');">Ubah</button>
...
<script>
    function setOutlet() {
        ...
        var myLatlng = new google.maps.LatLng(-8.16918334514732,113.70229443588259);
        var mapProp = {
            center:myLatlng,
            zoom:15,
    ...
    google.maps.event.addDomListener(window, 'load', setKodeOutlet);
