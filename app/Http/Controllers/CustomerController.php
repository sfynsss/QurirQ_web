    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            ->addColumn('action', function($row){
                ...
                $btn = "<a class='btn btn-warning m-r-10' href='' data-toggle='modal'  data-target='.bs-example-modal-lg' onclick='setIsi(`".$row->KD_CUST."`,`".$row->E_MAIL."`,`".$row->id."`);'><i class='icon ni ni-pen-alt-fill'></i>&nbsp;Ubah</a>";
